    ...
    class Map_Info
    {
        ...
        public void Open(string filename)
        {
            ...
            try
            {
                ...
                if (Map_Const.X < 1100) Map_Const.X = 1100;
        ...
        public void Save()
        {
            try
            {
                ...
                if (saveFileDlg.ShowDialog() == DialogResult.OK)
                {
                    ...
                    valuewrite[0] = (Map_Const.Map_Width + Map_Const.Width).ToString();
                    valuewrite[1] = (Map_Const.Map_Height + Map_Const.Height).ToString();
                    for (int i = 0; i < Map_Const.X; i++)
                        for (int j = 0; j < Map_Const.Y; j++)
                        {
                            if (Matrix[i, j] != "0")
